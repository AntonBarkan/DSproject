...
public class Peer 
{
   ...
   // private DiscoveryService discovery;
	...
	public void start() throws PeerGroupException, IOException {
        ...
        discovery = new Discovery(subgroup, this);
        ...
        PipeListener pl = new PipeListener(this);
        pipe_service.createInputPipe(get_advertisement(unicast_id, false), pl);
        pipe_service.createInputPipe(get_advertisement(multicast_id, true), pl);
